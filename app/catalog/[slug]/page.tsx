      ...
      <section className="bg-white py-12 md:py-16">
        <div className="shell">
          ...
          <div className="mt-8 grid gap-10 lg:grid-cols-[1.15fr_.85fr]">
            <div className="relative min-h-[420px] overflow-hidden rounded-2xl bg-zinc-100 md:min-h-[570px]"><img src={assetPath(item.image)} alt={item.name} className="absolute inset-0 h-full w-full object-cover" /><span className="absolute left-5 top-5 rounded-full bg-brand px-4 py-2 text-xs font-black uppercase">В наличии</span></div>
            <div>
              ...
              <dl className="mt-8 grid grid-cols-2 overflow-hidden rounded-2xl border-l border-t border-silver-dark/60">
